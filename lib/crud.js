    ...
    for (let towerNumber = 0; towerNumber < ConfBydTowerCount; towerNumber++) {
        ...
        myObjects = [
            ...
            [
                ...
                'state',
                `Balancing bitmask Tower 1`,  // Fix: war ${towerNumber}${1}
                'string',
                'value',
                true,
                false,
            ...
            [
                ...
                'state',
                `Balancing cell count Tower 1`,  // Fix: war ${towerNumber}${1}
                'number',
                'value',
                true,
                false,
        ...
        myObjectsCountTwo = [
            [
                ...
                'state',
                `Balancing bitmask Tower 2`,  // Fix: war ${towerNumber}${1} → erzeugte "11" etc.
                'string',
                'value',
                true,
                false,
            ...
            [
                ...
                'state',
                `Balancing cell count Tower 2`,  // Fix: war ${towerNumber}${1}
                'number',
                'value',
                true,
                false,
